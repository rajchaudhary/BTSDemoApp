          ...
          this.$().appendTo('body');
            ...
            _notifyDidInsertElement: function() {
                this.invokeRecursively(function(view) {
                    ...
                    // these jquery changes would only be implemented on finding the elements, which would not happen until the last view is inserted
                    //in the DOM .
                    if ($(document).height() != parseInt($('body').css('height'))){
                        $('#appFooter').removeAttr('style');
                    }else{
                        $('#appFooter').css('bottom',parseInt($('body').css('height'))-$(document).height());
                    }
